...
describe('whatIsInAName', () => {
  ...
  it('should return [{ "apple": 1 }, { "apple": 1 }, { "apple": 1, "bat": 2 }]', () => {
    const result = whatIsInAName([{ apple: 1 }, { apple: 1 }, { apple: 1, bat: 2 }], { apple: 1 });
    expect(result).to.have.deep.members([{ apple: 1 }, { apple: 1 }, { apple: 1, bat: 2 }]);
  });
  it('should return [{ "apple": 1, "bat": 2 }, { "apple": 1, "bat": 2, "cookie": 2 }]', () => {
    const result = whatIsInAName([{ apple: 1, bat: 2 }, { bat: 2 }, { apple: 1, bat: 2, cookie: 2 }], {
      apple: 1,
      bat: 2
    });
  ...
  it('should return [{ "apple": 1, "bat": 2, "cookie": 2 }]', () => {
    const result = whatIsInAName([{ apple: 1, bat: 2 }, { apple: 1 }, { apple: 1, bat: 2, cookie: 2 }], {
      apple: 1,
      cookie: 2
    });
  ...
  it('should return [{ "apple": 1, "bat": 2 }, { "apple": 1, "bat": 2, "cookie":2 }]', () => {
    const result = whatIsInAName([{ apple: 1, bat: 2 }, { apple: 1 }, { apple: 1, bat: 2, cookie: 2 }, { bat: 2 }], {
      apple: 1,
      bat: 2
    });
    expect(result).to.have.deep.members([
