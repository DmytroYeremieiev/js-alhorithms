...
describe('Heap', () => {
  ...
  it('MinHeap.extractMin', () => {
    const heap = new MinHeap([1, 2, 4], el => el, true);
  ...
  it('MaxHeap', () => {
    let heap = new MaxHeap([4, 2, 8, 9, 4, 12, 9, 11, 13], el => el, true);
    ...
    heap = new MaxHeap([1, 2, 4], el => el, true);
  ...
  it('MaxHeap.delete', () => {
    const heap = new MaxHeap([1, 2, 4], el => el, true);
    expect(heap.bin_tree_arr).to.be.deep.equal([4, 1, 2]);
